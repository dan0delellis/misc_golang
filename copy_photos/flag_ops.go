...
type Opts struct {
    ...
    DevID       string   `short:"D" long:"dev" description:"device path, relative to /dev/, to scan. Overrides blkidtab,fstypes,fslabels options entirely. Will not override nikonfile flag"`
    ...
    FsLabels    []string `short:"l" long:"fslabels" description:"filesystem labels to examine, not case-sensitive. Call multiple times for multiple values" default:"nikon"`
